...
class EnergyProfileScreen extends StatefulWidget {
  ...
  @override
  State<EnergyProfileScreen> createState() => _EnergySchedulingScreenState();
}

class _EnergySchedulingScreenState extends State<EnergyProfileScreen> {
  bool _isDarkMode = false;
  int _currentIndex = 5; // Current tab: Schedule
