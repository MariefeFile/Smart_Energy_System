...
class _AuthPageState extends State<AuthPage> {
  ...
  children: [
    ...
    IconButton(
      ...
      onPressed: () async {
        const fbUrl = 'https://www.facebook.com/v15.0/dialog/oauth'
        ...
        if (await canLaunchUrl(uri)) {
          ...
          if (!context.mounted) return;
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Could not launch Facebook Sign-In')),
          );
        }
      },
    ),
    ...
    IconButton(
      ...
      onPressed: () async {
        ...
        if (await canLaunchUrl(uri)) {
          ...
          if (!context.mounted) return;
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Could not launch Microsoft Sign-In')),
          );
        }
      },
    ),
